...
class DevelopersControllerTest < ActionController::TestCase
  ...
  test "should create developer" do
    assert_difference('Developer.count') do
      post :create, developer: { education: @developer.education, introduction: @developer.introduction, name: @developer.name }
    end
  ...
  test "should update developer" do
    patch :update, id: @developer, developer: { education: @developer.education, introduction: @developer.introduction, name: @developer.name }
    assert_redirected_to developer_path(assigns(:developer))
  end

...
class EdgesControllerTest < ActionController::TestCase
  ...
  test "should create edge" do
    assert_difference('Edge.count') do
      post :create, edge: { edge_type: @edge.edge_type, tag_id: @edge.tag_id, target_id: @edge.target_id }
    end
  ...
  test "should update edge" do
    patch :update, id: @edge, edge: { edge_type: @edge.edge_type, tag_id: @edge.tag_id, target_id: @edge.target_id }
    assert_redirected_to edge_path(assigns(:edge))
  end

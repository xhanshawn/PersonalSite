...
function build_force_directed_graph() {
  ...
  function draw_graph(graph){
    ...
    link.enter().append("svg:line")
        .attr("class", "link").attr('data-legend', function(d){return d.name;})
...
(function() {
  var add_tag, format_tag, remove_tag, tags_set;
  ...
  add_tag = function(tag_name, tag_button) {
    var hidden_input;
    hidden_input = $('<input>');
    ...
    return tag_button.append(hidden_input);
  };
  ...
  $(function() {
    ...
    $('.tag-button').each(function() {
      ...
      return tags_set[tag_name] = true;
    });
    return $('#add-tag-button').click(function() {
      var new_tag, remove_sign, tag_name;
      tag_name = $('#new-tag-input').val();
      tag_name = format_tag(tag_name);
      if (tag_name === '' || tags_set[tag_name]) {
...
(function() {
  ...
  draw = function(id_str) {
    var chart;
    chart = $('<div>');
    chart.attr('id', id_str);
    $('#tags-panel').empty();
    return $('#tags-panel').append(chart);
  };

  $(function() {
    var click_button, current_btn;
    if (!$('.tags').length) {
      return;
    }
    current_btn = null;
    click_button = function(btn) {
      console.log(btn);
      ...
      if (current_btn !== btn) {
        ...
        if (btn.id === 'bubble-chart-btn') {
          ...
          return build_force_directed_graph();
        }
      }
    };
    click_button($('.graph-btns .active')[0]);
    return $('.graph-btn').click(function() {
      return click_button(this);
    });
  });
